...
public class Main {
    final private static ArrayList<User> listUser = new ArrayList<>();
    final private static ArrayList<Profile> listUserProfile = new ArrayList<>();
    ...
    private static void showLoginMenu() {
        ...
        if (userIndex != -1) {  
            ...
            /*
             * TODO
             * Mengecek apakah password dari User yang login berdasarkan username2  3
    ...
    private static void showRegisterMenu() {
        ...
        while (username.isEmpty() || usernameTerpakai(username)) {
            ...
            if (usernameTerpakai(username)) {
                System.out.println("ERROR: Username Telah Terpakai");
